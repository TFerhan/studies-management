...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 13 déc. 2023 à 14:01
...
ALTER TABLE `eleve_has_groupe`
  ...
  ADD CONSTRAINT `eleve_has_groupe_ibfk_2` FOREIGN KEY (`idcours`) REFERENCES `cours` (`idcours`) ON DELETE CASCADE ON UPDATE CASCADE;
