...
class Filtrer(FlaskForm):
    ...
    debut = TimeField('Debut', validators=[DataRequired(message='Veuiller entrer l\'heure de debut')])
    fin = TimeField('Fin', validators=[DataRequired(message='Veuiller entrer l\'heure de fin')])
