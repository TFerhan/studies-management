...
--
-- Dechargement des donnees de la table `admins`
--
...
--
-- Dechargement des donnees de la table `cours`
--
...
CREATE TABLE `eleve` (
  ...
  `phone_ev` varchar(20) DEFAULT NULL COMMENT 'numero de telephone de l''elève\n',
  `numtel_par` varchar(20) DEFAULT NULL COMMENT 'numero de telephone du parent\r\n',
  `date_inscrit` date NOT NULL,
  `test` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dechargement des donnees de la table `eleve`
--
...
(145, 'Khalid', 'Amari', 'amari.khalid@gmail.com', '0654741254', '068547452', '2023-12-15', 0);
...
--
-- Dechargement des donnees de la table `eleve_has_cours`
--
...
--
-- Dechargement des donnees de la table `eleve_has_groupe`
--
...
--
-- Dechargement des donnees de la table `eleve_has_seance`
--
...
--
-- Dechargement des donnees de la table `enseignant`
--
...
--
-- Dechargement des donnees de la table `facture`
--
...
(122, 750, '2023-12-27 00:00:00', 145),
(123, 750, '2023-12-27 00:00:00', 2);
...
--
-- Dechargement des donnees de la table `formation`
--
...
--
-- Dechargement des donnees de la table `groupe`
--
...
CREATE TABLE `seance` (
  `idseance` int(11) NOT NULL,
  `type_seance` varchar(15) NOT NULL COMMENT 'la seance est presentiel ou en ligne',
  `enseignant_idenseignant` int(11) NOT NULL,
  `jour` varchar(15) NOT NULL,
  `debut` time NOT NULL,
  `fin` time NOT NULL,
  `idgroupe` int(11) NOT NULL, -- Adjusted length to match idgroupe in the groupe table
  `idcours` int(11) NOT NULL,
  `classe` varchar(8) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
--
-- Dechargement des donnees de la table `seance`
--

INSERT INTO `seance` (`idseance`, `type_seance`, `enseignant_idenseignant`, `jour`, `debut`, `fin`, `idgroupe`, `idcours`, `classe`) VALUES
...
--
ALTER TABLE `eleve`
  MODIFY `id_eleve` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=146;
...
--
ALTER TABLE `facture`
  MODIFY `idfacture` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;
...
--
ALTER TABLE `seance`
  MODIFY `idseance` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
...
--
ALTER TABLE `eleve_has_seance`
  ADD CONSTRAINT `eleve_has_seance_ibfk_1` FOREIGN KEY (`idseance`) REFERENCES `seance` (`idseance`) ON UPDATE CASCADE,
...
--
ALTER TABLE `seance`
  ADD CONSTRAINT `seance_ibfk_1` FOREIGN KEY (`idgroupe`) REFERENCES `groupe` (`idgroupe`) ON UPDATE CASCADE,
  ADD CONSTRAINT `seance_ibfk_2` FOREIGN KEY (`idcours`) REFERENCES `cours` (`idcours`) ON UPDATE CASCADE;
COMMIT;
