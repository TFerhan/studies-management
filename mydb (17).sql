...
--
-- Hôte : 127.0.0.1:3308
-- Généré le : jeu. 14 déc. 2023 à 22:46
...
--
ALTER TABLE `eleve`
  MODIFY `id_eleve` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=144;
...
--
ALTER TABLE `facture`
  MODIFY `idfacture` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;
